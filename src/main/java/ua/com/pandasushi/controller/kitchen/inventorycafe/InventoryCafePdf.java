...
public class InventoryCafePdf {
    private static final int ROW_COUNT = 18;
    private static final int COLUMN_COUNT = 5;
    private LinkedHashMap<Integer, ArrayList<InventoryCafe>> list;
    private Document check;
    private PdfWriter writer;
    private InventoryCafe inv;
    private int rowCount;
    private Header header;
    private String done;
    SimpleDateFormat sdf;

    InventoryCafePdf(LinkedHashMap<Integer, ArrayList<InventoryCafe>> list) throws FileNotFoundException, DocumentException {
        this.list = list;
        ...
        rowCount = 0;
        for (ArrayList<InventoryCafe> invs : this.list.values())
            rowCount += invs.size();
    ...
    void createPdf() throws DocumentException, IOException {
        ...
        for (Integer i : list.keySet()) {
            for (InventoryCafe inv : list.get(i)) {
