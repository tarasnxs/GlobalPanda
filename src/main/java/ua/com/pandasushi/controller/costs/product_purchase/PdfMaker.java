...
class PdfMaker {
    ...
    PdfMaker(ArrayList<Operations> productList, float finalSum) throws DocumentException, IOException {
    ...
    private PdfPTable getTable (List<Operations> list, int pageNumber, int pageCount) throws IOException, DocumentException {
        ...
        PdfPCell poCheku = new PdfPCell(new Phrase("По чеку", hFont));
        ...
        PdfPCell poFactu = new PdfPCell(new Phrase("По факту", hFont));
        ...
        PdfPCell commentar = new PdfPCell(new Phrase("Коментар", hFont));
        ...
        PdfPCell contragent = new PdfPCell(new Phrase("Контрагент : " + productList.get(0).getContrAgent() + "\nДо оплати : " + finalSum + " " + productList.get(0).getCurrency() + "\nОплачено : _______", hFont));
        PdfPCell operator = new PdfPCell(new Phrase("Оператор : " + productList.get(0).getOperator() + "\n__________________", hFont));
        PdfPCell cook = new PdfPCell(new Phrase("Прийняв : " + productList.get(0).getDescription1() + "\n__________________", hFont));
